...
[![x-cmd/install — python-lsp-server Code Quality Monitoring Repo Card](https://repo.x-cmd.io/python-lsp-server.svg)](https://x-cmd.com/install/python-lsp-server)
...
- **Stars**: 2,596 · **Forks**: 249 · **Open issues**: 360 · **Contributors**: 167

## Totals (cumulative)

- **Releases**: 35 · **Merged PRs**: 254 · **Open PRs**: 23 · **Closed issues**: 210 · **Open issues**: 150 · **Commits**: 621
...
_Snapshot: `data/card/260920.yml` · 2026-09-20T02:28:45Z._
